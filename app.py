...
assets = {
    "family": data_uri("assets/saye-family.webp.b64", "image/webp"),
...
st.markdown(
    ...
    [data-testid="stMain"] { overflow-y:auto !important; overflow-x:hidden !important; }
